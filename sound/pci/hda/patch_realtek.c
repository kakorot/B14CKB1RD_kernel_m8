...
struct alc_spec {
	...
	const struct snd_kcontrol_new *cap_mixer;	
	unsigned int beep_amp;	

	const struct hda_verb *init_verbs[10];	
	...
	int int_mic_idx, ext_mic_idx, dock_mic_idx; 
...
#else
#define add_loopback_list(spec, mix, idx) 
#endif
